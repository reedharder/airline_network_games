...
%for k=3000:4000-1
    ...
    delta_hat = 2*round(rand(p,1))-1;
    
    thetaplus=theta+ck*delta;
    thetaminus=theta-ck*delta;
    thetaplus_2=theta+ck*delta +ck*delta_hat;
    thetaminus_2=theta-ck*delta +ck*delta_hat;
    ...
    yplus_2= network_game_loss_quadratic(thetaplus_2,theta_norm,coef_map,base_coef,loss_metric,carriers,market_data_mat,fixed_carrier,fixed_market_carriers,fixed_markets,num_carriers,segment_competitors,Market_freqs,empirical_freqs,0,MAPE_incl,outfile_fn);
    yminus_2=network_game_loss_quadratic(thetaminus_2,theta_norm,coef_map,base_coef,loss_metric,carriers,market_data_mat,fixed_carrier,fixed_market_carriers,fixed_markets,num_carriers,segment_competitors,Market_freqs,empirical_freqs,0,MAPE_incl,outfile_fn);
